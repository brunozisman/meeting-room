package com.bnz.meetingroom.controller;

import com.bnz.meetingroom.exception.ResourceNotFoundException;
import com.bnz.meetingroom.model.Room;
import com.bnz.meetingroom.repository.RoomRepository;
...
public class RoomController {
    ...
    private Room findById(@PathVariable("id") Long id) throws ResourceNotFoundException {
